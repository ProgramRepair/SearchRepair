...
public interface SnippetListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SnippetParser#arrayExpr}.
	 * @param ctx the parse tree
	 */
	void enterArrayExpr(@NotNull SnippetParser.ArrayExprContext ctx);
	/**
	 * Exit a parse tree produced by {@link SnippetParser#arrayExpr}.
	 * @param ctx the parse tree
	 */
	void exitArrayExpr(@NotNull SnippetParser.ArrayExprContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SnippetParser#convertExpr}.
	 * @param ctx the parse tree
	 */
	void enterConvertExpr(@NotNull SnippetParser.ConvertExprContext ctx);
	/**
	 * Exit a parse tree produced by {@link SnippetParser#convertExpr}.
	 * @param ctx the parse tree
	 */
	void exitConvertExpr(@NotNull SnippetParser.ConvertExprContext ctx);
	/**
