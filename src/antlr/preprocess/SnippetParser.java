...
public class SnippetParser extends Parser {
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 3) | (1L << 4) | (1L << CallExpr) | (1L << Int) | (1L << Char) | (1L << Float) | (1L << ID) | (1L << INT) | (1L << FLOAT) | (1L << CharacterLiteral) | (1L << StringLiteral))) != 0)) {
				{
				{
	...
	public final MultiOperaterContext multiOperater() throws RecognitionException {
		...
		try {
			...
			setState(105);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 1) | (1L << 2) | (1L << 4))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
