...
public class IfBlockTestParser extends Parser {
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(85); match(LBR);
			setState(89);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << IF) | (1L << RETURN) | (1L << Int) | (1L << Char) | (1L << Float) | (1L << String) | (1L << Double) | (1L << ID) | (1L << POINTER))) != 0)) {
				{
				{
				setState(86); stat();
				}
	...
	public static class ReturnStatContext extends ParserRuleContext {
		public TerminalNode RETURN() { return getToken(IfBlockTestParser.RETURN, 0); }
	...
	public static final String _serializedATN =
		...
		"\b\n\f\16\20\22\24\26\30\32\34\36 \"$&(*,.\60\62\64\668:<\2\t\3\2\20\24"+
		...
		"\7#\2\2\u00a4\u00a5\7\30\2\2\u00a5\u00a6\7\"\2\2\u00a6\u00b7\5\"\22\2"+
		"\u00a7\u00a8\5\6\4\2\u00a8\u00a9\7#\2\2\u00a9\u00aa\7\30\2\2\u00aa\u00ab"+
		"\7\"\2\2\u00ab\u00ac\5\"\22\2\u00ac\u00b7\3\2\2\2\u00ad\u00ae\7\30\2\2"+
		"\u00ae\u00af\5$\23\2\u00af\u00b0\5\"\22\2\u00b0\u00b7\3\2\2\2\u00b1\u00b2"+
		"\7#\2\2\u00b2\u00b3\7\30\2\2\u00b3\u00b4\5$\23\2\u00b4\u00b5\5\"\22\2"+
